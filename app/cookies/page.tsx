  ...
  return (
    <div className="container max-w-4xl py-12 px-4">
      ...
      <div className="prose max-w-none">
        ...
        <p>
          This Cookie Policy explains how LinkSpark ("we", "us", or "our") uses cookies and similar technologies to
        ...
        <p className="mt-4">
          Cookies set by the website owner (in this case, LinkSpark) are called "first-party cookies". Cookies set by
